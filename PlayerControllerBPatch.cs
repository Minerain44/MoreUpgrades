...
namespace MoreUpgrades
{
    ...
    internal class PlayerControllerBPatch
    {
        ...
        [HarmonyPostfix]
        static void BeginGrabObjectPatch(PlayerControllerB __instance, ref GrabbableObject ___currentlyGrabbingObject, ref int ___interactableObjectsMask)
        {
            ...
            Debug.Log($"MoreUpgrades: Object Raycast: {hit}");
            ...
            if (___currentlyGrabbingObject.gameObject.layer != 8 && ___currentlyGrabbingObject.gameObject.tag == "PhysicsProp")
            {
